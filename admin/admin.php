<?php
add_action('admin_menu', 'newswire_admin_actions');

add_filter('plugin_action_links_newswire/newswirePublisher.php', '_plugin_action_links');

//var_dump(get_post_format_strings());die();

function newswire_admin_actions() {
  add_options_page('NEWSWIRE', 'Newswire Publisher', 'manage_options', __FILE__, 'newswire_admin');
}
...
function newswire_admin() {
  ...
  <div class="wrap">
      ...
      <form action="" method="POST">
        <input type="hidden" name="url" value="<?php echo get_site_url(); ?>/wp-content/plugins/newswire-wordpress-plugin/autoload.php">
          <table class="form-table">
              <tbody>
                  <tr>
                      <th>HTTP PUSH Endpoint (autoload) </th>
                      <td><?php echo get_site_url(); ?>/wp-content/plugins/newswire-wordpress-plugin/autoload.php</td>
                  </tr>
                  <tr>
                      <th scope="row">
