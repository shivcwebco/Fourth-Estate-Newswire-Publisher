...
function mvp_database_install() {
  ...
  //add_action('MVP_DATABASE_VERSION', __NAMESPACE__ . '\\MVP_DATABASE_VERSION');
}
...
add_action('wp_kses_allowed_html', __NAMESPACE__ . '\\custom_wpkses_post_tags', 10, 2);
...
add_action('plugins_loaded', __NAMESPACE__ . '\\mvp_database_update');
